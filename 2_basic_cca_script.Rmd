...
This script takes the scored data and runs CCA between empathy variables and internalizing symptom variables.
...
rcorr(res.cc$scores$xscores[,6], res.cc$scores$yscores[,6])
rcorr(res.cc$scores$xscores[,7], res.cc$scores$yscores[,7])
rcorr(res.cc$scores$xscores[,8], res.cc$scores$yscores[,8])
rcorr(res.cc$scores$xscores[,9], res.cc$scores$yscores[,9])

#put these things into a table
ccatable<- cbind(res.cc$cor, res.cc$cor^2, cca_signif(res.cc,mainX,mainY)[,1], cca_signif(res.cc,mainX,mainY)[,2],
      ...
      rcorr(res.cc$scores$xscores[,5], res.cc$scores$yscores[,5])$P[2,1], rcorr(res.cc$scores$xscores[,6], res.cc$scores$yscores[,6])$P[2,1], 
      rcorr(res.cc$scores$xscores[,7], res.cc$scores$yscores[,7])$P[2,1], rcorr(res.cc$scores$xscores[,8], res.cc$scores$yscores[,8])$P[2,1],
...
ggplot(data = cca_maindata, aes(x = res.cc$scores$xscores[,1], y = res.cc$scores$yscores[,1])) +
  geom_point() +
  theme_apa()+ 
  labs(x = "Empathy Synthetic Variable", y="Internalizing Synthetic Variable")+
...
xcoeftable <- cbind(standardised_xcanonical_coefficients(res.cc,mainX,mainY)[,1],structurecoefs$xvar.corr.r[2:10], ((structurecoefs$xvar.corr.r)^2)[2:10], structurecoefs$xvar.corr.p[2:10])
colnames(xcoeftable) <- c("stnd_x_can_coef","str_coef", "sq_str_coef","para_p")

ycoeftable <- cbind(standardised_ycanonical_coefficients(res.cc,mainX,mainY)[,1],structurecoefs$yvar.corr.r[2:11], ((structurecoefs$yvar.corr.r)^2)[2:11], structurecoefs$yvar.corr.p[2:11])
