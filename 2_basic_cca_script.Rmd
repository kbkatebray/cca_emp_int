...
cca_maindata <- read.csv("data_scored/cca_maindata.csv", header=TRUE, stringsAsFactors = FALSE)
```

## Main CCA script

This script takes the scored data and runs CCA between empathy variables and internalising symptom variables.
