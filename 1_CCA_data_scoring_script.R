...
# It also does some basic cleaning such as getting rid of pilots, and only retaining those who 
...
# and the Empathic Distress subscale  from the Empathic Responsiveness Questionnaire (Olweus & 
# Endresen, 1998).

# Tidy up by getting rid of ID variable which doesn't hold useful info
empathy$ID <- NULL
...
# (cog_emp, aff_shar and emp_conc are scored first as they have Likert scale with 5 points, 
# emp_dist has 6)
keys.listempathy1 <- list(cog_emp=c("F_T1_C_EMPATHY_1_1", "F_T1_C_EMPATHY_1_3","F_T1_C_EMPATHY_1_8",
                                    "F_T1_C_EMPATHY_1_10"),
                          aff_shar=c("F_T1_C_EMPATHY_1_5","F_T1_C_EMPATHY_1_7","F_T1_C_EMPATHY_1_9",
                                     "F_T1_C_EMPATHY_1_12"),
                          emp_conc=c("F_T1_C_EMPATHY_1_2","F_T1_C_EMPATHY_1_4","F_T1_C_EMPATHY_1_6",
                                     "F_T1_C_EMPATHY_1_11"))

# Subscale totals are created by summing the items, and imputing any missing by the mean
# note - FALSE:average, TRUE:sum
empathyscored1 <- scoreItems(keys.listempathy1,empathy, impute= "mean", totals=TRUE, min=1,max=5) 
...
empathyscored2 <- scoreItems(keys.listempathy2,empathy, impute= "mean", totals=TRUE, min=1,max=6) 

# empathyscored$scores #The scores themselves
empathy_subscales2 <- as.data.frame(empathyscored2$scores)#the totals

# raw scores and totals together
empathy <- cbind(empathy, empathy_subscales1, empathy_subscales2)

# This step excludes any participants who have less than 70% of the subscale items present 
# (more than 1 item missing for cog_emp, aff_shar and emp_conc and any items missing for emp_dist)
# cog_emp
empathy[which(rowSums(is.na(empathy[, c("F_T1_C_EMPATHY_1_1", "F_T1_C_EMPATHY_1_3","F_T1_C_EMPATHY_1_8",
                                        "F_T1_C_EMPATHY_1_10")]))>1),"cog_emp"] <- NA
#aff_shar
empathy[which(rowSums(is.na(empathy[, c("F_T1_C_EMPATHY_1_5","F_T1_C_EMPATHY_1_7","F_T1_C_EMPATHY_1_9",
                                        "F_T1_C_EMPATHY_1_12")]))>1),"aff_shar"] <- NA
#empconc
empathy[which(rowSums(is.na(empathy[, c("F_T1_C_EMPATHY_1_2","F_T1_C_EMPATHY_1_4","F_T1_C_EMPATHY_1_6",
                                        "F_T1_C_EMPATHY_1_11")]))>1),"emp_conc"] <- NA
#emp_dist
empathy[which(rowSums(is.na(empathy[, c("F_T1_C_EMPATHY_2_1","F_T1_C_EMPATHY_2_2",
                                        "F_T1_C_EMPATHY_2_3")]))>0),"emp_dist"] <- NA
...
keys.listcCDI <- list(totalCDI=c("F_T1_C_CDI_1", "-F_T1_C_CDI_2", "F_T1_C_CDI_3", "F_T1_C_CDI_4",
                                 "F_T1_C_CDI_5", "-F_T1_C_CDI_6", "-F_T1_C_CDI_7", "F_T1_C_CDI_8",
                                 "-F_T1_C_CDI_9", "-F_T1_C_CDI_10", "F_T1_C_CDI_11", "-F_T1_C_CDI_12",
                                 "F_T1_C_CDI_13", "-F_T1_C_CDI_14", "-F_T1_C_CDI_15", "F_T1_C_CDI_16",
                                 "-F_T1_C_CDI_17", "F_T1_C_CDI_18", "F_T1_C_CDI_19", "-F_T1_C_CDI_20",
                                 "F_T1_C_CDI_21", "F_T1_C_CDI_22", "-F_T1_C_CDI_23", "-F_T1_C_CDI_24",
                                 "F_T1_C_CDI_25", "-F_T1_C_CDI_26", "-F_T1_C_CDI_27", "F_T1_C_CDI_28"),
                      emo_cCDI=c("F_T1_C_CDI_1","-F_T1_C_CDI_9","-F_T1_C_CDI_10","-F_T1_C_CDI_15",
                                 "F_T1_C_CDI_16", "-F_T1_C_CDI_17", "F_T1_C_CDI_18","-F_T1_C_CDI_26",
                                 "-F_T1_C_CDI_27", "-F_T1_C_CDI_2","-F_T1_C_CDI_6","-F_T1_C_CDI_7",
                                 "F_T1_C_CDI_8", "F_T1_C_CDI_13","-F_T1_C_CDI_24"),
                      negmood_phys=c("F_T1_C_CDI_1","-F_T1_C_CDI_9","-F_T1_C_CDI_10","-F_T1_C_CDI_15",
                                     "F_T1_C_CDI_16", "-F_T1_C_CDI_17", "F_T1_C_CDI_18","-F_T1_C_CDI_26",
                                     "-F_T1_C_CDI_27"), 
                      neg_selfest=c("-F_T1_C_CDI_2","-F_T1_C_CDI_6","-F_T1_C_CDI_7", "F_T1_C_CDI_8",
                                    "F_T1_C_CDI_13","-F_T1_C_CDI_24"),
                      func_cCDI=c("F_T1_C_CDI_3", "F_T1_C_CDI_4","-F_T1_C_CDI_12", "-F_T1_C_CDI_14",
                                  "-F_T1_C_CDI_20","F_T1_C_CDI_22", "-F_T1_C_CDI_23", "F_T1_C_CDI_28",
                                  "F_T1_C_CDI_5","F_T1_C_CDI_11","F_T1_C_CDI_19","F_T1_C_CDI_21", 
                                  "F_T1_C_CDI_25"),
                      ineff=c("F_T1_C_CDI_3" , "F_T1_C_CDI_4","-F_T1_C_CDI_12", "-F_T1_C_CDI_14",
                              "-F_T1_C_CDI_20","F_T1_C_CDI_22", "-F_T1_C_CDI_23", "F_T1_C_CDI_28"),
                      intprobs=c("F_T1_C_CDI_5","F_T1_C_CDI_11","F_T1_C_CDI_19","F_T1_C_CDI_21", 
                                 "F_T1_C_CDI_25"))

# note - FALSE:average, TRUE:sum
CDIscored <- scoreItems(keys.listcCDI,child_CDI, impute= "mean", totals=TRUE, min=0,max=2) 
...
# This step excludes any participants who have less than 70% of the subscale items present 
# negmood
child_CDI[which(rowSums(is.na(child_CDI[, c("F_T1_C_CDI_1","F_T1_C_CDI_9","F_T1_C_CDI_10",
                                            "F_T1_C_CDI_15" , "F_T1_C_CDI_16" , "F_T1_C_CDI_17",
                                            "F_T1_C_CDI_18","F_T1_C_CDI_26" , "F_T1_C_CDI_27")]))>2)
          ,"negmood_phys"] <- NA

#neg_selfest
child_CDI[which(rowSums(is.na(child_CDI[, c("F_T1_C_CDI_2","F_T1_C_CDI_6","F_T1_C_CDI_7", 
                                            "F_T1_C_CDI_8", "F_T1_C_CDI_13","F_T1_C_CDI_24")]))>1),
          "neg_selfest"] <- NA

#ineff
child_CDI[which(rowSums(is.na(child_CDI[, c("F_T1_C_CDI_3" , "F_T1_C_CDI_4","F_T1_C_CDI_12", 
                                            "F_T1_C_CDI_14","F_T1_C_CDI_20","F_T1_C_CDI_22", 
                                            "F_T1_C_CDI_23", "F_T1_C_CDI_28")]))>2),"ineff"] <- NA
#intprobs
child_CDI[which(rowSums(is.na(child_CDI[, c("F_T1_C_CDI_5","F_T1_C_CDI_11","F_T1_C_CDI_19",
                                            "F_T1_C_CDI_21", "F_T1_C_CDI_25")]))>1),"intprobs"] <- NA
...
keys.listSCAS <- list(totalSCAS=c("F_T1_C_SCAS_1","F_T1_C_SCAS_2","F_T1_C_SCAS_3","F_T1_C_SCAS_4",
                      ...
                      scasopanicag=c("F_T1_C_SCAS_13","F_T1_C_SCAS_21","F_T1_C_SCAS_28","F_T1_C_SCAS_30" , 
                                     "F_T1_C_SCAS_32","F_T1_C_SCAS_34","F_T1_C_SCAS_36","F_T1_C_SCAS_37",
                                     "F_T1_C_SCAS_39"),
...
SCASscored <- scoreItems(keys.listSCAS, SCAS, impute= "mean", totals=TRUE, min=0,max=3) 
# note - FALSE:average, TRUE:sum
...
SCAS[which(rowSums(is.na(SCAS[, c("F_T1_C_SCAS_13","F_T1_C_SCAS_21","F_T1_C_SCAS_28","F_T1_C_SCAS_30", 
                                  "F_T1_C_SCAS_32","F_T1_C_SCAS_34","F_T1_C_SCAS_36","F_T1_C_SCAS_37",
                                  "F_T1_C_SCAS_39")]))>2),"scasopanicag"] <- NA
...
keys.listsilentfilms <- list(silent_films_total=c("F_T1_C_SF_1","F_T1_C_SF_2","F_T1_C_SF_3",
                                                  "F_T1_C_SF_4","F_T1_C_SF_5","F_T1_C_SF_6"))

# Subscale totals are created by summing the items, and imputing any missing by the mean
sfscored <- scoreItems(keys.listsilentfilms, silent_films, impute= "mean", totals=TRUE, min=0,max=2)
# note - FALSE:average, TRUE:sum
...
silent_films[which(rowSums(is.na(silent_films[, c("F_T1_C_SF_1","F_T1_C_SF_2","F_T1_C_SF_3",
                                                  "F_T1_C_SF_4","F_T1_C_SF_5","F_T1_C_SF_6")]))>1),
             "silent_films_total"] <- NA
...
WISC$Total_scaledscores <- WISC$F_T1_C_WISC_vocab_scale + WISC$F_T1_C_WISC_mat_scale + 
  WISC$F_T1_C_WISC_sym_scale
...
list.of.data.frames = list(switchboard, empathy, silent_films, child_CDI, SCAS, WISC, parent_demog,
                           SEIFA)
...
#Next, get rid of the participants who have all their data missing 
# - these are people who did not come back for wave 2
