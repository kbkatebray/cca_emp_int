...
apa_table(ccatable,
          ...
          col.names = c("Dimension",	"Canonical Correlation (Rc)",	"Canonical Correlation Squared (Rc2)",	"Wilk’s λ",	"Multiple F",	"df1",	"df2",	"Parametric p-value for F (3 d.p.) (and non-parametric)",	"Parametric p-value for Rc (and non-parametric)")
)
```
