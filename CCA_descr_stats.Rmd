...
my_dataset_scored <- read.csv("cca_data_scored.csv", header=TRUE, stringsAsFactors = FALSE)
setwd("C:/Users/Kate/SkyDrive/PhD/CCA/CCA_raw_data/")#Read in the ethinicity 
ethnic_race <- read.csv("37_F_T1_FollowUP_ParIV.csv", header=TRUE, stringsAsFactors = FALSE)
```
...
apa.cor.table(corrmatrix , filename="C:/Users/Kate/SkyDrive/PhD/CCA/plots/Table1_APA.doc", table.number=1)
...
write.csv(ccaonlyethnic, file = "C:/Users/Kate/SkyDrive/PhD/CCA/CCA_scored_data/ccaonlyethnic.csv")

#This next step has been manually coded - can just read in this file if rerunning without changes, or recode if have changed number of participnats
setwd("C:/Users/Kate/SkyDrive/PhD/CCA/CCA_scored_data/")
ethnic_coded <- read.csv("ccaonlyethnic_coded.csv", header=TRUE, stringsAsFactors = FALSE)
...
male_cdi_tscores <- read.csv("C:/Users/Kate/SkyDrive/PhD/CCA/CCA_raw_data/male_cdi_tscores.csv", 
                             header=TRUE, stringsAsFactors = FALSE)
female_cdi_tscores <- read.csv("C:/Users/Kate/SkyDrive/PhD/CCA/CCA_raw_data/female_cdi_tscores.csv", 
                               header=TRUE, stringsAsFactors = FALSE)
...
cca_maindata$CDIcategory<- ifelse(cca_maindata$totalCDI_tscores < 65, 1, ifelse(cca_maindata$totalCDI_tscores >= 65, 2, NA))
...
male_scas_tscores <- read.csv("C:/Users/Kate/SkyDrive/PhD/CCA/CCA_raw_data/SCAS_boys_tscores.csv", 
                             header=TRUE, stringsAsFactors = FALSE)
female_scas_tscores <- read.csv("C:/Users/Kate/SkyDrive/PhD/CCA/CCA_raw_data/SCAS_girls_tscores.csv", 
                               header=TRUE, stringsAsFactors = FALSE)
